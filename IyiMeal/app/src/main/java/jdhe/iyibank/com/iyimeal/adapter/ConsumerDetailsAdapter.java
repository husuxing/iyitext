...
public class ConsumerDetailsAdapter extends BaseAdapter {
    ...
    public ConsumerDetailsAdapter(Activity context) {//, List<User> users, boolean isNearPeople) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(context, R.layout.consumerdetails_adapterlayout, null);
