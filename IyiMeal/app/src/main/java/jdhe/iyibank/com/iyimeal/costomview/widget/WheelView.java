...
public class WheelView extends View {
	/** Scrolling duration */
	private static final int SCROLLING_DURATION = 0;//400
	...
	private static final int ADDITIONAL_ITEM_HEIGHT = 0;//15
	...
	private static final int ADDITIONAL_ITEMS_SPACE =0;//2

	/** Label offset , dip */
	private static int LABEL_OFFSET_DIP = 0;//20
	/** Label offset */
	private static int LABEL_OFFSET = 20;//30

	/** Left and right padding value */
	private static final int PADDING = 3;//10
