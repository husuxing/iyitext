...
public class Classification_of_dishesFragment  extends BaseFragment implements View.OnClickListener,IClassification_of_dishesView {
    ...
    public Classification_of_dishesFragment() {
    }


    public static Classification_of_dishesFragment newInstance(String param1, String param2) {
        Classification_of_dishesFragment fragment = new Classification_of_dishesFragment();
    ...
    public static Classification_of_dishesFragment newInstance() {
        Classification_of_dishesFragment fragment = new Classification_of_dishesFragment();
        Bundle args = new Bundle();
        fragment.setArguments(args);
        return fragment;
    ...
    public void setList(ArrayList<BatchAddTableBean> batchAddTableBeens) {
        mAdapter = new CommonAdapter<BatchAddTableBean>(getContext(), R.layout.classification_of_dishes_itemlayout, batchAddTableBeens)
        {
            ...
            protected void convert(ViewHolder myViewHolder, BatchAddTableBean batchAddTableBean, int position) {
                myViewHolder.setVisible(R.id.money,false);
