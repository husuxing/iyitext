...
public class FloatingItemDecoration extends RecyclerView.ItemDecoration {
    ...
    //    private float mTitToplineOffset;
     ...
     */
    public FloatingItemDecoration(Context context, @ColorInt int color, @Dimension float dividerWidth, @Dimension float dividerHeight, @Dimension float mTitToplineOffset) {
...
//        this.mTitToplineOffset = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, mTitToplineOffset, context.getResources().getDisplayMetrics());
        init(context);
    }
    ...
    private void init(Context mContext) {
        ...
        mBackgroundPaint.setColor(ContextCompat.getColor(mContext, R.color.white2));//Color.MAGENTA);//
    }
...
//                Log.e(TAG, "onDrawOver: "+child.getTop()+"$"+firstVisiblePos );
        ...
        mTextPaint1.setStrokeWidth(10);
        mTextPaint1.setColor(ContextCompat.getColor(mContext,R.color.yellow67));

        Paint mTextPaint4 = new Paint();
        mTextPaint4.setAntiAlias(true);
        mTextPaint4.setStyle(Paint.Style.FILL);
        mTextPaint4.setStrokeWidth(1);
        mTextPaint4.setColor(ContextCompat.getColor(mContext,R.color.graydb));
        c.drawLine(20, bottom, MyAppLication.screenW,bottom, mTextPaint4);
        c.drawLine(left + 20, bottom-10, getTextWidth(mTextPaint,title)+20, bottom-10, mTextPaint1);
        if (flag) {
            //还原画布为初始状态
            c.restore();
        }
...
//        outRect.top = (int) mTitToplineOffset;
    }
...
//        }
        ...
        for (int i = 0; i < parent.getChildCount(); i++) {
            ...
            if (!keys.containsKey(params.getViewLayoutPosition())) {
                ...
                mTextPaint1.setAntiAlias(true);
                mTextPaint1.setStyle(Paint.Style.FILL);
                mTextPaint1.setStrokeWidth(20);
                mTextPaint1.setColor(ContextCompat.getColor(mContext,R.color.yellow67));
                c.drawLine(left + 20, bottom, getTextWidth(mTextPaint,keys.get(params.getViewLayoutPosition()))+20, bottom, mTextPaint1);
                Paint mTextPaint4 = new Paint();
                mTextPaint4.setAntiAlias(true);
                mTextPaint4.setStyle(Paint.Style.FILL);
                mTextPaint4.setStrokeWidth(1);
                ...
                mTextPaint2.setStrokeWidth((mTitleHeight - mTextHeight) / 2);
                mTextPaint2.setColor(ContextCompat.getColor(mContext,R.color.huif5));
                c.drawLine(0, top, MyAppLication.screenW,top, mTextPaint2);
//                Paint mTextPaint3 = new Paint();
//                mTextPaint3.setAntiAlias(true);
//                mTextPaint3.setStyle(Paint.Style.FILL);
//                mTextPaint3.setStrokeWidth(1);
//                mTextPaint3.setColor(ContextCompat.getColor(mContext,R.color.gray));
//                c.drawLine(0, bottom-(mTitleHeight - mTextHeight) / 2-mTextHeight-20 , MyAppLication.screenW,bottom-(mTitleHeight - mTextHeight) / 2-mTextHeight-20 , mTextPaint3);
            }
        }
    }
